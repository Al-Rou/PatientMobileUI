...
import ViewPatientsScreen from './ViewPatientScreen';
        ...
        return(
            <View >
                ...
                <View style= {{flex : 13 , flexDirection : 'row' }}>
                    ...
                    <TouchableHighlight
                           style = {[GlobalStyles.appButtonContainerTwo ,  {flex: 2 ,flexDirection:'column' }]} onPress={()=>this.listRecords(item._id)}>
